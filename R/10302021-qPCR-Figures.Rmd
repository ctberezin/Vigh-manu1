...
```{r}
pomc <- read.csv("C:/Users/ctber/Documents/Image-Processing-Vigh/qPCR/08202021-POMC-final.csv", fileEncoding = 'UTF-8-BOM')
...
```{r}
mcko <- read.csv("C:/Users/ctber/Documents/Image-Processing-Vigh/qPCR/08162021-McKO-totalret-final.csv", fileEncoding = 'UTF-8-BOM')
mcko <- mcko %>% 
...
```
>>>>>>> 7f4c0144ed0f2e1679d3132d57c8fbe2ccbe1a1f
