...
car::Anova(ModelcircaLD, type = 3)
options(contrasts = c("contr.sum", "contr.poly"))
emmeans(ModelcircaLD, pairwise ~ phase|Condition)$contrasts
emmeans(ModelcircaLD, pairwise ~ Condition|phase)$contrasts

Modelcircad <- lm(sleep_fraction ~ Condition*phase, data = summary_meltyLD)
car::Anova(Modelcircad, type="3")
emmeans(Modelcircad, pairwise ~ phase|Condition)$contrasts
emmeans(Modelcircad, pairwise ~ Condition|phase)$contrasts
```
