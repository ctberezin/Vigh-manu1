...
ggsave(filename="../figures/pomc_circ_males.png", plot=pomc_circ_m_plot, height=3, width=3)
...
ggsave(filename="../figures/pomc_ld_m_only.png", plot=pomc_ld_m_plot, height=3, width=3)
...
ggsave(filename="../figures/pomc_all_males.png", plot=timeplot_m, height=4, width=3)
...
timeplot_log_m <- ggplot(m_pomc_all, aes(x=Time, y=log(RelativeGE))) +
  stat_summary(fun = 'mean', geom="bar", fill="gray40") +
  geom_point(size=2) +
  facet_wrap(~Light) +
  stat_summary(fun.data = mean_se, geom = "errorbar", width=.1) +
...
ggsave(filename="../figures/pomc_all_males_log.png", plot=timeplot_log_m, height=4, width=3)
