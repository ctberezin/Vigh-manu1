...
ggsave(filename="../figures/pomc_circ.png", plot=pomc_circ_plot, height=3, width=3)
```
...
pomc_ld_plot <- ggplot(pomc_ld, aes(x=Time, y=Relative.G.E.)) +
  geom_point() +
  theme_few() +
  facet_wrap(~Light) +
  labs(x="",
...
ggsave(filename="../figures/pomc_ld_facet_by_time.png", plot=pomc_ld_plot, height=3, width=3)
```
