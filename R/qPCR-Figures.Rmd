...
pomc_ld_m_lm <- lm(Relative.G.E. ~ Light*Time, pomc_ld_m)
anova(pomc_ld_m_lm)
pomc_ld_m_av <- aov(pomc_ld_m_lm)
TukeyHSD(pomc_ld_m_av)
...
pomc_ld_f_lm <- lm(Relative.G.E. ~ Light*Time, pomc_ld_f)
anova(pomc_ld_f_lm)
pomc_ld_f_av <- aov(pomc_ld_f_lm)
TukeyHSD(pomc_ld_f_av)
