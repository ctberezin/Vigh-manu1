...
interaction.plot(x.factor=counts$time,
                 trace.factor=counts$light,
                 response=counts$GCL_bendo_mm,
                 fun=median)
interaction.plot(x.factor=counts$light,
                 trace.factor=counts$time,
                 response=counts$GCL_bendo_mm,
                 fun=median)
```
