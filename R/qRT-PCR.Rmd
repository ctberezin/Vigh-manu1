...
pomc_circ_m_plot <- ggplot() +
  stat_summary(data=pomc_circ_males, aes(x=Time, y=Relative.GE), fun = 'mean', geom="bar", fill=c("yellow", "yellow", "grey70")) +
...
#ggsave(filename="../figures/pomc_circ_m.png", plot=pomc_circ_m_plot, height=4, width=4)
...
#ggsave(filename="../figures/pomc_ld_m.png", plot=pomc_ld_m_plot, height=4, width=4)
...
pomc_all_m <- ggplot() +
  stat_summary(data=m_pomc_all, aes(x=Light, y=RelativeGE, fill=Light), fun = 'mean', geom="bar") +
...
pomc_all_m_log <- ggplot() +
  stat_summary(data=m_pomc_all, aes(x=Light, y=log(RelativeGE), fill=Light), fun = 'mean', geom="bar") +
...
#ggsave(filename="../figures/pomc_all_m_log.png", plot=pomc_all_m_log, height=4, width=6)
...
mcko_plot <- ggplot() +
  stat_summary(data=mcko, aes(x=Genotype, y=Relative.GE, fill=Genotype), fun = 'mean', geom="bar") +
