...
#ggsave(filename="../figures/pomc_hyp_ret.svg", plot=pomc_hyp_plot, height=4, width=6)
...
#ggsave(filename="../figures/pomc_hyp_ret_log.png", plot=pomc_hyp_log_plot, height=4, width=6)
```



```{r}
pomc_hyp <- read.csv("../data/06092022-POMC-hypothalamus-only.csv",
                     fileEncoding = 'UTF-8-BOM')
...
ggsave(filename="../figures/pomc_hyp.png", plot=pomc_hyp_plot, height=4, width=4)
...
ggsave(filename="../figures/pomc_hyp_log.png", plot=pomc_hyp_log_plot, height=4, width=4)
```
